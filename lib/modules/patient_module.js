...
function categories_data_to_schema_patient_data(connection, data, date) {
    return new Promise(async(resolve, reject) => {
        try {
            var dob, patientdob, first_visit_date, first_visitdate, patient_id;
            var seq_type='PAT';
    ...
    return new Promise(async(resolve, reject) => {
        try {
            ...
            var patientdata = {
                ...
                alternative_mobile_no: (data.hasOwnProperty('alternative_mobile_no'))?data.alternative_mobile_no:get_patient.alternative_mobile_no, 
                email_id: (data.hasOwnProperty('email_id'))?data.email_id:get_patient.email_id, 
                alternative_email_id: (data.hasOwnProperty('alternative_email_id'))?data.alternative_email_id:get_patient.alternative_email_id, 
                first_visit_date: first_visit_date, 
