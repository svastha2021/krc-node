    ...
    getAppointmentMobileByBranchId(connection, mobile_no, branch_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT *, DATE_FORMAT(appoint_date,'%Y-%m-%d') AS appoint_date FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details WHERE phone_no='${mobile_no}' AND branch_id='${branch_id}'`;
    ...
    getAppointmentPatientByBranchId(connection, patient_id, branch_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT *, DATE_FORMAT(appoint_date,'%Y-%m-%d') AS appoint_date FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details WHERE patient_id='${patient_id}' AND branch_id='${branch_id}'`;
    ...
    getAppointmentDoctorByBranchId(connection, doctor_id, branch_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT *, DATE_FORMAT(appoint_date,'%Y-%m-%d') AS appoint_date FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details 
    ...
    getAppointmentAppointDateByBranchId(connection, appoint_date, branch_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT *, DATE_FORMAT(appoint_date,'%Y-%m-%d') AS appoint_date FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details WHERE appoint_date='${appoint_date}' AND branch_id='${branch_id}'`;
    ...
    getAppointmentListbyBranchId(connection, branch_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT *, DATE_FORMAT(appoint_date,'%Y-%m-%d') AS appoint_date FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details WHERE branch_id='${branch_id}'`;
    ...
    getAppointmentDetailById(connection, appointment_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Appt_Details WHERE appoint_no='${appointment_id}'`;
