...
class ConsultDao extends BaseDao {
    ...
    GetConsultingListsByBranchId(connection, branch_id, query) {
        return new Promise(async(resolve, reject)=> {
            try{
                var custQuery;
                if(connection == null) {
                ...
                if(query.filter.patient_id) {
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE branch_id='${branch_id}' AND patient_id='${query.filter.patient_id}'`;
                }
                else if(query.filter.doctor_id) {
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE branch_id='${branch_id}' AND doctor_id='${query.filter.doctor_id}'`;
                }
                else{
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE branch_id='${branch_id}'`;
                }
    ...
    GetConsultingListsByOrgId(connection, org_id, query, strPagination) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                if(query.filter.patient_id) {
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE org_id='${org_id}' AND patient_id='${query.filter.patient_id}'`;
                }
                else if(query.filter.doctor_id) {
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE org_id='${org_id}' AND doctor_id='${query.filter.doctor_id}'`;
                }
                else if(query.filter.branch_id) {
                    custQuery = `SELECT * FROM ${process.env.WRITE_DB_DATABASE}.Patient_Consult_Header WHERE org_id='${org_id}' AND branch_id='${query.filter.branch_id}'`;
                }
                else{
